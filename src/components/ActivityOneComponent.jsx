...
function ActivityOne() {
  return (
    <div id="app">
      ...
      <p>
        Build a <MainGoal /> component and insert it below this text.
      </p>
      <p>
        Your <MainGoal /> component should simply output some text that
        describes your main course goal (e.g., &quot;My main goal: Learn React
        in great detail&quot;).
      </p>
      <p>
